...
// List of teams
const teams = [
  { id: 1, name: "Chennai Kings", color: "yellow" },
  { id: 2, name: "Mumbai Warriors", color: "blue" },
  { id: 3, name: "Madurai Fighters", color: "red" },
  { id: 4, name: "Trichy Blasters", color: "green" },
  { id: 5, name: "Kovai Legends", color: "purple" },
  { id: 6, name: "Dindigul Warriors", color: "orange" },
  { id: 7, name: "Salem Smashers", color: "pink" },
  { id: 8, name: "Erode Thunders", color: "teal" },
  { id: 9, name: "Tirunelveli Tuskers", color: "indigo" },
  { id: 10, name: "Thoothukudi Titans", color: "gray" },
]
