...
// Team data with purse information
...
export const teams: Team[] = [
  { id: 1, name: "Chennai Kings", color: "yellow", purse: 10000, spent: 0, players: [] },
  { id: 2, name: "Mumbai Warriors", color: "blue", purse: 10000, spent: 0, players: [] },
  { id: 3, name: "Madurai Fighters", color: "red", purse: 10000, spent: 0, players: [] },
  { id: 4, name: "Trichy Blasters", color: "green", purse: 10000, spent: 0, players: [] },
  { id: 5, name: "Kovai Legends", color: "purple", purse: 10000, spent: 0, players: [] },
  { id: 6, name: "Dindigul Warriors", color: "orange", purse: 10000, spent: 0, players: [] },
  { id: 7, name: "Salem Smashers", color: "pink", purse: 10000, spent: 0, players: [] },
  { id: 8, name: "Erode Thunders", color: "teal", purse: 10000, spent: 0, players: [] },
  { id: 9, name: "Tirunelveli Tuskers", color: "indigo", purse: 10000, spent: 0, players: [] },
  { id: 10, name: "Thoothukudi Titans", color: "gray", purse: 10000, spent: 0, players: [] },
]
